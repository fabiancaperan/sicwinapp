...
namespace core.UseCase.InitDatabase
{
    public class InitDb
    {
        ...
        {
            var json = @"[{'Nemo':'CONVSA1','diaini':'JU','Numdías':7,'Descripcion':'Comfama debito','emisor':'004 ','NIT':'8909008419','tiponegocio':'501','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SA','bolsillo':3},
                          {'Nemo':'CONVSA2','diaini':'LU','Numdías':7,'Descripcion':'Comfenalco Ctgena D','emisor':'005 ','NIT':'8904800237','tiponegocio':'502','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SA','bolsillo':2},
                          {'Nemo':'CONVSA3','diaini':'LU','Numdías':7,'Descripcion':'Combarranquilla D','emisor':'008 ','NIT':'8901020022','tiponegocio':'503','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SA','bolsillo':2},
                          {'Nemo':'CONVSA4','diaini':'LU','Numdías':7,'Descripcion':'Comfamar Debito','emisor':'017 ','NIT':'8903040338','tiponegocio':'504','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SA','bolsillo':1},
                          {'Nemo':'CONVSB1','diaini':'LU','Numdías':7,'Descripcion':'Comfama credito','emisor':'004 ','NIT':'8909008419','tiponegocio':'506','tipotrans':1,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SB','bolsillo':5},
                          {'Nemo':'CONVSB2','diaini':'LU','Numdías':7,'Descripcion':'Comfenalco Ctgena Cr','emisor':'005 ','NIT':'8904800237','tiponegocio':'507','tipotrans':1,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SB','bolsillo':3},
                          {'Nemo':'CONVSA5','diaini':'LU','Numdías':7,'Descripcion':'Comfacundi Debito','emisor':'018 ','NIT':'860045904','tiponegocio':'505','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SA','bolsillo':1},
                          {'Nemo':'CONVSB3','diaini':'LU','Numdías':7,'Descripcion':'Redeban Fondo Cr','emisor':'015 ','NIT':'8001735076','tiponegocio':'509','tipotrans':0,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SB','bolsillo':1},
                          {'Nemo':'CONVSA6','diaini':'LU','Numdías':7,'Descripcion':'Comfenalco Ant Db','emisor':'016 ','NIT':'8909008426','tiponegocio':'508','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SA','bolsillo':2},
                          {'Nemo':'CONVSA7','diaini':'LU','Numdías':7,'Descripcion':'Comfamiliar Atl Db','emisor':'009 ','NIT':'8901019949','tiponegocio':'511','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SA','bolsillo':2},
                          {'Nemo':'CONVSC2','diaini':'LU','Numdías':7,'Descripcion':'Comfenalco Ctgena BD','emisor':'005 ','NIT':'8904800237','tiponegocio':'564','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SC','bolsillo':8},
                          {'Nemo':'CONVSC7','diaini':'LU','Numdías':7,'Descripcion':'Comfamiliar Atl DS','emisor':'009 ','NIT':'8901019949','tiponegocio':'568','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SC','bolsillo':7},
                          {'Nemo':'CONVSF7','diaini':'LU','Numdías':7,'Descripcion':'Comfamiliar Atl BR','emisor':'009 ','NIT':'8901019949','tiponegocio':'569','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SF','bolsillo':6},
                          {'Nemo':'CONVSB7','diaini':'LU','Numdías':7,'Descripcion':'Comfamiliar Atl BE','emisor':'009 ','NIT':'8901019949','tiponegocio':'567','tipotrans':1,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SB','bolsillo':4},
                          {'Nemo':'CONVSC1','diaini':'JU','Numdías':7,'Descripcion':'Comfama debito CM','emisor':'004 ','NIT':'8909008419','tiponegocio':'510','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SC','bolsillo':2},
                          {'Nemo':'CONVSF1','diaini':'JU','Numdías':7,'Descripcion':'Comfama debito BN','emisor':'004 ','NIT':'8909008419','tiponegocio':'518','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SF','bolsillo':4},
                          {'Nemo':'CONVSA8','diaini':'LU','Numdías':7,'Descripcion':'Comfenalco tolima Db','emisor':'044 ','NIT':'8907001484','tiponegocio':'516','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SA','bolsillo':2},
                          {'Nemo':'CONVSA9','diaini':'LU','Numdías':7,'Descripcion':'Comfenalco Stder Db','emisor':'045 ','NIT':'8902015787','tiponegocio':'533','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SA','bolsillo':2},
                          {'Nemo':'CONVSA0','diaini':'LU','Numdías':7,'Descripcion':'Comfacesar','emisor':'046 ','NIT':'8002110251','tiponegocio':'543','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SA','bolsillo':2},
                          {'Nemo':'CONVSP3','diaini':'LU','Numdías':7,'Descripcion':'Comfaca ','emisor':'047 ','NIT':'00','tiponegocio':'571','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SP','bolsillo':1},
                          {'Nemo':'CONVSAB','diaini':'LU','Numdías':7,'Descripcion':'Comfacauca','emisor':'048 ','NIT':'9815001820','tiponegocio':'2039','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SA','bolsillo':1},
                          {'Nemo':'CONVSAC','diaini':'LU','Numdías':7,'Descripcion':'Comfamiliar Caldas','emisor':'050 ','NIT':'8908064905','tiponegocio':'2053','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SA','bolsillo':1},
                          {'Nemo':'CONVSP4','diaini':'LU','Numdías':7,'Descripcion':'Comfaguajira','emisor':'051 ','NIT':'00','tiponegocio':'951','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SP','bolsillo':1},
                          {'Nemo':'CONVSP2','diaini':'LU','Numdías':7,'Descripcion':'Comfacor','emisor':'052 ','NIT':'00','tiponegocio':'570','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SP','bolsillo':1},
                          {'Nemo':'CONVSP6','diaini':'LU','Numdías':7,'Descripcion':'Comfamiliar Huila','emisor':'053 ','NIT':'00','tiponegocio':'953','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SP','bolsillo':1},
                          {'Nemo':'CONVSAA','diaini':'LU','Numdías':7,'Descripcion':'Comfandi Muj Ahorr','emisor':'057 ','NIT':'8903032085','tiponegocio':'2054','tipotrans':2,'Servidor':'localhost','Usuario':'1','Clave':'','COD_CONCEPTO':'SA','bolsillo':1}
                        ]";
